...
public class MailService {
	...
	private static final String USER = ""; // Must be valid user in d.umn.edu
											// domain, e.g. "smit0012"
	private static final String PASSWORD = ""; // Must be valid password for
												// smit0012
	private static final String FROM = ""; // Full info for user, e.g.
